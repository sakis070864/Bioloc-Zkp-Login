...
export async function middleware(request: NextRequest) {
    ...
    if (process.env.NODE_ENV === 'production') {
        ...
        response.headers.set(
            ...
            "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://*.google.com https://*.googleapis.com; font-src 'self' data:; connect-src 'self' https://*.googleapis.com https://*.firebaseio.com https://*.cloudfunctions.net;"
        );
    }
